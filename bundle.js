...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	  ...
	  showLazyModal: function showLazyModal() {
	    this.setState({ showLazyModal: true });
	  },
	  hideLazyModal: function hideLazyModal() {
	    this.setState({ showLazyModal: false });
	  },
	  render: function render() {
	    var _state = this.state;
	    var showModal = _state.showModal;
	    var showLazyModal = _state.showLazyModal;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var notifyOnTouchEnd = _props.notifyOnTouchEnd;
	
	    var props = _objectWithoutProperties(_props, ['onClose', 'notifyOnTouchEnd']);
